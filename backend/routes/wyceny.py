...
# iter95dw: blok BOM (Bill of Materials / RFQ) + Suppliers wydzielony do wyceny_bom.py.
# Wszystkie endpointy `/wyceny/{id}/bom*` i `/wyceny/suppliers/*` sa zarejestrowane
# przez bom_router (include_router na koncu pliku).
from routes.wyceny_bom import router as _bom_router  # noqa: E402
from routes.wyceny_bom import _build_bom, _generate_bom_xlsx_bytes, _generate_bom_pdf_bytes  # noqa: F401,E402

router.include_router(_bom_router)


# iter95ds: helpery PDF/XLSX wydzielone do wyceny_helpers.py (split z ~3422 linii).
from routes.wyceny_helpers import (  # noqa: F401,E402
    _get_logo_path,
    _pdf_safe,
    _register_pdf_fonts,
    _pdf_text,
