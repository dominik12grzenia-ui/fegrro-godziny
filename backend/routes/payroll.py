...
async def list_payroll(
    ...
    # bierzemy DEFAULTS z najnowszego poprzedniego miesiaca. Nie zapisujemy - tylko
    # prezentujemy w UI; pierwszy zapis utrwala wartosci.
    # PRZENOSZONE: rate, is_fixed_salary, fixed_salary_amount, driver_zl (stale przypisanie).
    # NIE PRZENOSZONE (zerowane w nowym miesiacu): bonus_zl, other_plus_zl, other_minus_zl
    # (sa to dodatki specyficzne dla danego miesiaca, np. premia za projekt).
    ...
    if missing_emp_ids:
        ...
        async for r in cursor:
            ...
            defaults_cache[eid] = {
                ...
                # Dodatki/premie/inne sa specyficzne miesiacowo - nie kopiujemy
                "bonus_zl": 0.0,
                "other_plus_zl": 0.0,
                "other_minus_zl": 0.0,
            }
