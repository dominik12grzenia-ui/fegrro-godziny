...
export default function WarehouseTokenEntry() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center p-4" data-testid="warehouse-token-entry">
      <div className="text-center">
        <div className="mx-auto mb-4 w-20 h-20 rounded-full bg-[#E8B76A]/20 flex items-center justify-center animate-pulse">
          <Warehouse className="h-10 w-10 text-[#E8B76A]" />
        </div>
        <p className="text-[#E8B76A] text-lg font-bold">Otwieranie panelu magazyniera...</p>
